...
// Scene FX spawners (dust/blood/spark bursts, ground-crush decals) are no longer
// part of the public scene API. They are registered with the engine FX hook table
// in scene_init(); gameplay code triggers them via fx_*() in fx_hooks.h.
